package com.dqc.qlibrary.db.common.task;

import android.os.Handler;
import android.os.Looper;
import android.os.Message;

import com.dqc.qlibrary.db.common.Callback;
            ...
            try {
                switch (msg.what) {
                    ...
                    case MSG_WHAT_ON_CANCEL: {
                        ...
                        assert args != null;
                        taskProxy.task.onCancelled((com.dqc.qlibrary.db.common.Callback.CancelledException) args[0]);
                        break;
                    }
