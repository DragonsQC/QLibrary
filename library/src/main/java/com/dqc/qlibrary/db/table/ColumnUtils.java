...
package com.dqc.qlibrary.db.table;

import com.dqc.qlibrary.db.converter.ColumnConverter;
import com.dqc.qlibrary.db.converter.ColumnConverterFactory;
    ...
    static Method findGetMethod(Class<?> entityType, Field field) {
        ...
        if (getMethod == null) {
            ...
            try {
                ...
                QLog.d(entityType.getName() + "#" + methodName + " not exist");
            }
        }
